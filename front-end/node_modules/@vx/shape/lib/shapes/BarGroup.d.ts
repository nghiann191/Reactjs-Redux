...
export declare type BarGroupProps<Datum> = {
...
export default function BarGroupComponent<Datum extends {
    [key: string]: $TSFIXME;
}>({ data, className, top, left, x0, x0Scale, x1Scale, yScale, color, keys, height, children, ...restProps }: BarGroupProps<Datum> & Omit<React.SVGProps<SVGRectElement>, keyof BarGroupProps<Datum>>): JSX.Element;
