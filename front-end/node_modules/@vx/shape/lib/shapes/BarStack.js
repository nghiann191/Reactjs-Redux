...
function BarStackComponent(_ref) {
  ...
  var barStacks = stacks.map(function (barStack, i) {
    ...
    return {
      ...
      bars: barStack.map(function (bar, j) {
        ...
        var barX = 'bandwidth' in xScale && typeof xScale.bandwidth === 'function' ? xScale(x(bar.data)) : Math.max(xScale(x(bar.data)) - barWidth / 2);
        return {
          bar: bar,
          key: key,
          index: j,
  ...
  if (children) return _react.default.createElement(_react.default.Fragment, null, children(barStacks));
  return _react.default.createElement(_group.Group, {
    className: (0, _classnames.default)('vx-bar-stack', className),
    top: top,
    left: left
...
BarStackComponent.propTypes = {
  ...
  y0: _propTypes.default.func,
  y1: _propTypes.default.func,
  xScale: _propTypes.default.any.isRequired,
  yScale: _propTypes.default.any.isRequired,
