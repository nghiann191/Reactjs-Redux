...
function BarGroupComponent(_ref) {
  ...
  if (children) return _react.default.createElement(_react.default.Fragment, null, children(barGroups));
...
BarGroupComponent.propTypes = {
  ...
  x0Scale: _propTypes.default.any.isRequired,
  x1Scale: _propTypes.default.any.isRequired,
  yScale: _propTypes.default.any.isRequired,
  color: _propTypes.default.func.isRequired,
  keys: _propTypes.default.arrayOf(_propTypes.default.any).isRequired,
