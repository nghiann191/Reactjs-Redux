        ...
        b => ({
          ...
          y: _.reduce(
            _.filter(
              data[index].data,
              c =>
                moment(c.x).format("GGGG WW") === moment(b.x).format("GGGG WW")
            ),
  ...
  return (
    <div>
      <div style={{float:'right'}}>
        <Button color="link" onClick={() => setState("day")}>Day</Button>
        <Button color="link" onClick={() => setState("week")}>Week</Button>
        <Button color="link" onClick={() => setState("month")}>Month</Button>
      </div>
      {status ? <LineChartSpinner/> : (
        <div>
